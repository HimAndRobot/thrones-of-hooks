<div x-data="main" class="w-full h-[100vh] bg-[#141517] flex justify-center items-center">
    <div class="w-11/12 h-5/6 max-w-[1800px]  rounded-lg flex">
        ...
        <div x-show="selectedOption != null"  class="w-9/12 h-full bg-[#1b1919] px-20 pt-[40px] overflow-y-scroll scrollbar-thumb-rounded-md scrollbar scrollbar-thumb-[#00000033] ">
